...
from realitygraph.abgp.manifest import (
...
class ABGPManifestTests(unittest.TestCase):
    ...
    def test_review_manifest_cannot_enable_confirmation(self):
    ...
    def test_analysis_plan_is_normative_and_review_pending(self):
