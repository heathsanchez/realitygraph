...
class ABGPLockTests(unittest.TestCase):
    def setUp(self):
        ...
        self.files = {
            "realitygraph/abgp/analysis.py": "analysis-v1\n",
            "realitygraph/abgp/arm_a.py": "arm-a-v1\n",
            "realitygraph/abgp/arm_b.py": "arm-b-v1\n",
            "realitygraph/abgp/arm_g.py": "arm-g-v1\n",
            "realitygraph/abgp/arm_p.py": "arm-p-v1\n",
            "realitygraph/abgp/runner.py": "runner-v1\n",
        }
        self.runtime = {
    ...
    def test_scientific_code_change_changes_review_lock_digest(self):
        ...
        changed["realitygraph/abgp/arm_g.py"] = "arm-g-v2\n"
        second = build_review_lock(changed, self.runtime)
        self.assertNotEqual(first["scientific_code_hashes"]["realitygraph/abgp/arm_g.py"], second["scientific_code_hashes"]["realitygraph/abgp/arm_g.py"])
