...
class ABGPFreezeBlockerTests(unittest.TestCase):
    ...
    def test_b_records_use_real_recovery_and_real_bisimulation_control(self):
        ...
        self.assertTrue(all(record.bisimulation_separation_witness for record in records))
        ...
        self.assertTrue(any(record.bisimulation_bayes_success == 0 for record in records))
    ...
    def test_g_exchangeability_contract_is_design_level_and_fail_closed(self):
        ...
        self.assertTrue(audit["joint_world_vector_exchangeability_under_null"])
        self.assertTrue(audit["selection_fixed_before_outcomes"])
