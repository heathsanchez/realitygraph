...
_BOUND_FILES = (
    ...
    "realitygraph/abgp/executed_p.py",
    ...
    "realitygraph/abgp/p_structural_posterior_worker.py",
    "realitygraph/abgp/sandbox_runtime.py",
)
    ...
    *,
    ...
    lock: dict[str, Any] = {
        ...
        "arm_generator_code_hashes": {
            "A": hashes["realitygraph/abgp/executed_a.py"],
            "B": hashes["realitygraph/abgp/executed_b.py"],
            "G": hashes["realitygraph/abgp/executed_g.py"],
            "P": hashes["realitygraph/abgp/executed_p_structural.py"],
        },
        "verifier_implementation_hash": hashes["realitygraph/abgp/executed_a.py"],
        "protected_evaluator_hash": hashes["realitygraph/abgp/executed_g.py"],
        "analysis_implementation_hash": hashes["realitygraph/abgp/analysis.py"],
        "grammar_family_generator_hashes": {
            family: hashes["realitygraph/abgp/executed_b.py"]
            for family in ("extensional", "compositional", "reachability", "constraint_order")
        },
        "sham_object_construction_hash": hashes["realitygraph/abgp/executed_p_structural.py"],
        "wrong_class_construction_hash": hashes["realitygraph/abgp/executed_b.py"],
        "corruption_implementation_hash": hashes["realitygraph/abgp/executed_g.py"],
        "ablation_implementation_hash": hashes["realitygraph/abgp/p_structural_invocation_worker.py"],
        "ordinary_explanation_oracle_hashes": {
            "A": hashes["realitygraph/abgp/executed_a.py"],
            "B": hashes["realitygraph/abgp/executed_b.py"],
            "P": hashes["realitygraph/abgp/p_structural_posterior_worker.py"],
        },
        ...
        "inferential_unit_audit_hashes": {
            arm: hashes["realitygraph/abgp/executed_matrix.py"] for arm in ("A", "B", "G", "P")
        },
