...
def analyze_direction_iut(
    ...
    *,
    ...
    """Conservative intersection-union analysis for B.

    The primary unit is one fresh latent world nested inside one ordered
    acquisition->transfer grammar direction.  The four structural interventions
    are repeated measurements inside that unit; they are never counted as
    independent observations.  Each direction is tested separately against each
    primary control and the arm-level p-value is the maximum component p-value.
    """
