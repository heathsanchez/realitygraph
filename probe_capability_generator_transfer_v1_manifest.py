...
SEED="realitygraph-capability-generator-transfer-v1-source-only"
...
def main():
    ...
    req=urllib.request.Request(PMLB,headers={"User-Agent":"RealityGraph capability generator transfer V1 manifest"})
    ...
    Path("capability-generator-transfer-v1-manifest.json").write_text(json.dumps(out,sort_keys=True,indent=2)+"\n")
