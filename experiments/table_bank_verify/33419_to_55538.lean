-- RealityGraph compiled table-bank certificate: 33419_to_55538
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G) (u : G), x ◇ (y ◇ z) = w ◇ ((u ◇ z) ◇ z)
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  ...
  change (25 : Fin 26) = 1 at bad
  exact (by decide : Not ((25 : Fin 26) = 1)) bad
...
theorem certificate_33419_to_55538 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_55538
