-- RealityGraph compiled table-bank certificate: 33419_to_4802
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  intro h
  have bad := h (0 : Fin 26) (1 : Fin 26) (0 : Fin 26)
...
theorem certificate_33419_to_4802 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_4802
