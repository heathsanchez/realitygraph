-- RealityGraph compiled table-bank certificate: 33419_to_3392
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G), x ◇ y = z ◇ (x ◇ (w ◇ y))
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  ...
  change (0 : Fin 26) = 1 at bad
  exact (by decide : Not ((0 : Fin 26) = 1)) bad
...
theorem certificate_33419_to_3392 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_3392
