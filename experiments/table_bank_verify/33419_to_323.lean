-- RealityGraph compiled table-bank certificate: 33419_to_323
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G), x ◇ y = x ◇ (x ◇ y)
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  ...
  change (8 : Fin 26) = 25 at bad
  exact (by decide : Not ((8 : Fin 26) = 25)) bad
...
theorem certificate_33419_to_323 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_323
