-- RealityGraph compiled term-model certificate: 5837_to_42832
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G), x ◇ y = y ◇ (y ◇ ((z ◇ w) ◇ w))
...
theorem target : ¬ EquationRHS T := by
  intro h
  have bad := h T.e T.e T.e T.e
  change T.R (T.e) (T.e) = T.E (T.e) (T.e) at bad
  simp at bad
...
theorem certificate_5837_to_42832 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_42832
