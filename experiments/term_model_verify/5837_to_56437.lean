-- RealityGraph compiled term-model certificate: 5837_to_56437
...
theorem target : ¬ EquationRHS T := by
  ...
  change T.M (T.e) (T.e) = T.R (T.R (T.e) (T.e)) (T.R (T.e) (T.e)) at bad
  simp at bad
...
theorem certificate_5837_to_56437 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_56437
