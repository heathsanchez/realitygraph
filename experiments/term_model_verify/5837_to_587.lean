-- RealityGraph compiled term-model certificate: 5837_to_587
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G) (u : G), x = y ◇ (z ◇ (z ◇ (w ◇ u)))
...
theorem target : ¬ EquationRHS T := by
  intro h
  have bad := h T.E (T.e) (T.e) T.e T.e T.e T.e
  change T.E (T.e) (T.e) = T.e at bad
  simp at bad
...
theorem certificate_5837_to_587 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_587
