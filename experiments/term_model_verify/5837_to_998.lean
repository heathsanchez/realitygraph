-- RealityGraph compiled term-model certificate: 5837_to_998
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G) (u : G), x = y ◇ ((z ◇ w) ◇ (x ◇ u))
...
theorem target : ¬ EquationRHS T := by
  ...
  change T.e = T.R (T.R (T.R (T.e) (T.e)) (T.R (T.e) (T.e))) (T.e) at bad
  simp at bad
...
theorem certificate_5837_to_998 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_998
