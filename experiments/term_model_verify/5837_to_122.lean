-- RealityGraph compiled term-model certificate: 5837_to_122
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G), x = y ◇ ((x ◇ z) ◇ z)
...
theorem target : ¬ EquationRHS T := by
  intro h
  have bad := h T.e T.e T.e
  change T.e = T.M (T.e) (T.R (T.e) (T.e)) at bad
  simp at bad
...
theorem certificate_5837_to_122 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_122
