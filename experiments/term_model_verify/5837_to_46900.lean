-- RealityGraph compiled term-model certificate: 5837_to_46900
...
theorem target : ¬ EquationRHS T := by
  ...
  change T.R (T.e) (T.e) = T.R (T.R (T.e) (T.R (T.e) (T.e))) (T.R (T.e) (T.e)) at bad
  simp at bad
...
theorem certificate_5837_to_46900 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_46900
