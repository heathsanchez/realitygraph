-- RealityGraph compiled term-model certificate: 5837_to_53919
...
theorem target : ¬ EquationRHS T := by
  ...
  change T.M (T.e) (T.e) = T.E (T.e) (T.e) at bad
  simp at bad
...
theorem certificate_5837_to_53919 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_5837_to_53919
