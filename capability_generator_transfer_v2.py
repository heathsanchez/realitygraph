...
MANIFEST_SHA="0c4266bdb6c96c9b9a4883f1a6238d02ccb686e5323446829d71224a4c6a3244"
...
def protocol_cfg():
    return {
      "version":"capability-generator-transfer-v2-evidence",
...
def main():
    ...
    if len(dev_base)<7 or len(held_base)<10:
        ...
        Path(os.environ.get("REALITYGRAPH_GENERATOR_RESULT","capability-generator-transfer-v2-summary.json")).write_text(json.dumps(result,sort_keys=True,indent=2)+"\n")
    ...
    generator_policy={
      "version":"capability-generator-transfer-v2",
    ...
    print("REALITYGRAPH / CAPABILITY GENERATOR TRANSFER V2")
    print("-----------------------------------------------")
