-- RealityGraph compiled table-bank certificate: 33419_to_3587
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G), x ◇ y = z ◇ ((x ◇ y) ◇ y)
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  intro h
  have bad := h (0 : Fin 26) (0 : Fin 26) (1 : Fin 26)
...
theorem certificate_33419_to_3587 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_3587
