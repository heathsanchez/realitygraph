-- RealityGraph compiled table-bank certificate: 33419_to_3412
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G) (u : G), x ◇ y = z ◇ (y ◇ (w ◇ u))
...
theorem certificate_33419_to_3412 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_3412
