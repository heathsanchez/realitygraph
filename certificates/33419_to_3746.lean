-- RealityGraph compiled table-bank certificate: 33419_to_3746
...
@[reducible] def EquationRHS (G : Type _) [Magma G] : Prop := ∀ (x : G) (y : G) (z : G) (w : G), x ◇ y = (x ◇ z) ◇ (w ◇ w)
...
theorem target_false : ¬ EquationRHS (Fin 26) := by
  intro h
  have bad := h (0 : Fin 26) (0 : Fin 26) (1 : Fin 26) (0 : Fin 26)
  change (0 : Fin 26) = 8 at bad
  exact (by decide : Not ((0 : Fin 26) = 8)) bad
...
theorem certificate_33419_to_3746 : ∃ (G : Type) (_ : Magma G), EquationLHS G ∧ ¬ EquationRHS G := submission
#print axioms certificate_33419_to_3746
