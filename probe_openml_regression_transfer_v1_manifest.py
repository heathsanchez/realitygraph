...
SEED="realitygraph-openml-regression-transfer-v1-source-only"
...
def main():
    ...
    req=urllib.request.Request(PMLB,headers={"User-Agent":"RealityGraph regression transfer manifest"})
    ...
    Path("openml-regression-transfer-v1-manifest.json").write_text(json.dumps(out,sort_keys=True,indent=2)+"\n")
